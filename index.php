...
<head>
	...
	<style>
	    ...
	    <link rel="stylesheet" href="../profile/style/clock.css">
...
<body style="background-color:lightcoral;" onload="startTime()">
	<a href="../profile/profile.php"><i class="glyphicon glyphicon-home" style="font-size: 31px;margin-top: 15px;color: white;">AIO</i></a>
			<div id="clockdate">
	...
	<div class='container'>
		...
		<div class="col-md-12">
			<div class="row shadow p-3 mb-5 bg-white rounded mydiv">
				<h1><center style="color: red;font-weight: bold;" >ADVANCED<strong style="color:black;"> AIO</strong> CALCULATOR</center></h1>
